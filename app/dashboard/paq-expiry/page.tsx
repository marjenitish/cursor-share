...
export default function PAQExpiryPage() {
  ...
  const fetchPendingCustomers = async () => {
    ...
    const { data, error } = await supabase
      .from('customers')
      .select('*')
      .lt('paq_filled_date', new Date(new Date().setFullYear(new Date().getFullYear() - 1)).toISOString())
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold tracking-tight">Expired PAQs</h1>
