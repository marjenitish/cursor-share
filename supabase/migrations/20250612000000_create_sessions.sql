...
CREATE TABLE public.sessions (
  ...
  term_id bigint REFERENCES terms(id), -- Changed to bigint to match terms table id type
  zip_code text,
  day_of_week text NOT NULL, -- Changed to text to match terms table
...
CREATE INDEX idx_classes_exercise_type_id ON classes(exercise_type_id); 
